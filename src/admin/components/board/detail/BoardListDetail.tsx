...
const BoardListDetail = () => {
  ...
  return (
    <div className="contents">
      <CommonBreadcrumb oneDepth={'게시판관리'} twoDepth={'게시판'} threeDepth={id} />
      <div className="contents-items">
        <div className="contents-title">게시판 상세</div>
          ...
          <div className="footer">
            <div className="right">
              <div className="buttons">
                ...
                <Button variant="outline-primary ms-2 mw-80px" onClick={() => void navigate('/admin/board/boardList')}>
                  목록
                </Button>
              </div>
            </div>
