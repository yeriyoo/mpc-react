...
const NoticeDetail = () => {
  ...
  return (
    <div className="contents">
      <CommonBreadcrumb oneDepth={'게시판관리'} twoDepth={'공지사항'} threeDepth={id} />
      <div className="contents-items">
        <div className="contents-title">공지사항 상세</div>
                  ...
                  <tr>
                    <td>
                      <div className="d-flex aligh-items-center gap-3">
                        <div>
                          <span className="fw-bold me-2">일반노출 기간</span> 2024-01-01 ~ 2024-01-01
                        </div>
          ...
          <div className="footer">
            <div className="right">
              <div className="buttons">
                ...
                <Button variant="outline-primary ms-2 mw-80px" onClick={() => void navigate('/admin/board/notice')}>
                  목록
                </Button>
              </div>
            </div>
