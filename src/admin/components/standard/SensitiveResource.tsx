...
import AddSensitiveModal from '@/admin/components/standard/modal/AddSensitiveModal.tsx';
...
const SensitiveResource = () => {
  ...
  return (
    <div className="contents">
      <CommonBreadcrumb oneDepth={'기준정보'} twoDepth={'민감자원지도'} />
      <div className="contents-items">
        <div className="contents-title">민감자원지도</div>
      ...
      {isShowModal && <AddSensitiveModal isShow={isShowModal} setIsShow={() => setIsShowModal(false)} />}
    </div>
  );
};
export default SensitiveResource;
