        ...
        <div className="contents">
          <div className="breadcrumb-group">
            <Breadcrumb>
              ...
              <Breadcrumb.Item active>QNA 등록/수정</Breadcrumb.Item>
            </Breadcrumb>
          </div>
          <div className="contents-items">
            <div className="contents-title">QNA 등록/수정</div>
                  ...
                  <Table>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <th>공개여부</th>
                        <td className="align-middle">
                          <Form.Check type="radio" inline id="" label="공개" className="mb-0" />
                          <Form.Check type="radio" inline id="" label="비공개" className="mb-0" />
                        </td>
                      </tr>
                      <tr>
                        <th>내용</th>
    ...
    <Modal size="sm" centered show={modal1show} onHide={() => setmodal1Show(false)}>
      ...
      <Modal.Body>
        <div className="alert-text-group">
          <div className="text1">
            문의의 답변은 "마이페이지 &lt; 내가 쓴글"<br /> 에서도 확인이 가능합니다.
          </div>
        </div>
      </Modal.Body>
      <Modal.Footer>
...
export default Mpc1Sub3Menu3S2;
