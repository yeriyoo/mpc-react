        ...
        <div className="contents">
          <div className="breadcrumb-group">
            <Breadcrumb>
              ...
              <Breadcrumb.Item active>공지사항 상세</Breadcrumb.Item>
            </Breadcrumb>
          </div>
                      ...
                      <tr>
                        <td>
                          <div className="d-flex aligh-items-center gap-3">
                            <div><span className="fw-bold me-2">일반노출 기간</span> 2024-01-01 ~ 2024-01-01</div>
                            <div className="divider-vertical" />
                            <div><span className="fw-bold me-2">등록자</span> 김공지</div>
                            <div className="divider-vertical" />
                            <div><span className="fw-bold me-2">등록일</span> 2024-01-01</div>
                            <div className="divider-vertical" />
...
export default Mpc1Sub3Menu1S1;
