...
import { mdiArrowRightBottom, mdiLock } from '@mdi/js';
        ...
        <div className="contents">
          <div className="breadcrumb-group">
            <Breadcrumb>
              ...
              <Breadcrumb.Item active>QNA</Breadcrumb.Item>
            </Breadcrumb>
          </div>
          <div className="contents-items">
            <div className="contents-title">QNA</div>
            <div className="contents-info mb-3">
              해양환경 위기대응 통합시스템 문의 게시판입니다.<br />
              ...
              <div className="body">
                <div className="grid-group">
                  ...
                  <div className="realgrid-group">
                    ...
                    <Icon path={mdiLock} className="icon-admin icon-mdi icon-grid icon-lock" onClick={() => setmodal1Show(true)} />
