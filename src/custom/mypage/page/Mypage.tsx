                  ...
                  <div className="items-group">
                    <div className="header underline">
                      ...
                      <div className="header-control ms-auto">
                        ...
                        <div className="text-group text-666666">
                          <strong>최종 업데이트 : </strong>2024-08-01 12:00:00
                        </div>
                        ...
                        <div className="list-group-item">
                          <div className="ship-item">
                            <div className="ship-info">
                              ...
                              <div className="text-group text-16 text-666666">
                                412330220 <span className="text-divider"></span> Cargo
                              </div>
                            </div>
                ...
                <div className="col">
                  ...
                  <div className="items-group">
                    <div className="header underline">
                      ...
                      <div className="ms-1">
                        <button className="nbtn nbtn-text">
                          <i className="icon-gcsc icon-xls icon-left"></i> 예외사항 등록 양식.xlsx
                        </button>
                      </div>
                      <div className="header-control ms-auto">
                        <button className="nbtn nbtn-secondary min-width">업데이트</button>
