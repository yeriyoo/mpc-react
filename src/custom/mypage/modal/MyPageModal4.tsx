/**
 * 설명: 마이페이지 관심선박/영역정보_관심영역팝업
 **/
import styles from '@/assets/scss/modal/common/commonModal.module.scss';

const MyPageFavoriteModal4 = ({ isShow }: { isShow: VoidFunction }) => {
  return (
          ...
          <div className={`${styles['modal-content-style']}`}>
            ...
            <div className={`${styles['control-group']} ${styles['mb-10']}`}>
              ...
              <div className={styles['right']}>
                <button className={`${styles['nbtn']} ${styles['nbtn-secondary']}`}>단축키설정</button>
...
export default MyPageFavoriteModal4;
