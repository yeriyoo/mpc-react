    ...
    <div className="d-flex flex-column flex-wrap gap-2 p-3">
      ...
      <div className="mt-3">
        ...
        <div className="d-flex align-items-center flex-wrap gap-3 p-3">
          <Button variant="primary" className="btn-xs">기상예보</Button>
      ...
      <div className="mt-3">
        ...
        <div className="d-flex align-items-center flex-wrap gap-3 p-3">
          ...
          <Button variant="outline-primary" className="btn-text-icon rounded-pill">초기화 <i className="icon-admin icon-button icon-refresh2 ms-2"></i></Button>
          ...
          <Button variant="outline-primary" className="btn-text-icon">찾기 <i className="icon-gcsc icon-button icon-search2 ms-1"></i></Button>
          <Button variant="outline-primary" className="btn-text-icon">파일찾기 <i className="icon-gcsc icon-button icon-search2 ms-1"></i></Button>
          <Button variant="outline-primary" className="btn-text-icon">예약 <i className="icon-gcsc icon-button icon-time ms-2"></i></Button>
          <Button variant="outline-primary" size="sm" className="btn-text-icon">사진 등록/삭제 <i className="icon-gcsc icon-button icon-image ms-2"></i></Button>
          ...
          <Button variant="outline-primary" className="btn-text-icon">수집 작업 등록 <i className="icon-admin icon-button icon-download ms-2"></i></Button>
          <Button variant="outline-primary" className="btn-text-icon">조회 <i className="icon-admin icon-button icon-search2 ms-1"></i></Button>
          <Button variant="outline-primary" className="btn-text-icon">중복체크 <i className="icon-admin icon-button icon-check ms-2"></i></Button>
          <Button variant="outline-primary" className="btn-text-icon">탈퇴 <i className="icon-admin icon-button icon-close ms-2"></i></Button>
          ...
          <Button variant="outline-primary" size="sm">그룹에 배정</Button>
      ...
      <div className="mt-3">
        ...
        <div className="d-flex align-items-center flex-wrap gap-3 p-3 bg-dark-subtle">
          ...
          <Button variant="icon"><i className="icon-gcsc icon-button size-30 icon-close2"></i></Button>
          <Button variant="icon"><i className="icon-gcsc icon-button size-30 icon-search"></i></Button>
          <Button variant="icon"><i className="icon-gcsc icon-button size-30 icon-setting"></i></Button>
          <Button variant="icon"><i className="icon-gcsc icon-button size-30 icon-collapse"></i></Button>
          <Button variant="icon"><i className="icon-gcsc icon-button size-30 icon-setting-outline"></i></Button>
          ...
          <Button variant="icon"><i className="icon-admin icon-button size-30 icon-refresh"></i></Button>
          <Button variant="icon"><i className="icon-admin icon-button size-30 icon-search"></i></Button>
      ...
      <div className="mt-3">
        <h4>ETC</h4>
        <div className="d-flex align-items-center flex-wrap gap-3 p-3">
          <Button variant='accordion-arrow'><i className="icon-gcsc icon-accordion icon-accordion-arrow"></i></Button>
          <Button variant='accordion-arrow' active><i className="icon-gcsc icon-accordion icon-accordion-arrow"></i></Button>
          ...
          <Button variant="offcanvas-close"><i className="icon-gcsc icon-offcanvas icon-offcanvas-close"></i></Button>
      ...
      <div className="mt-3">
        <h4>Link1</h4>
        <div className="d-flex align-items-center flex-wrap gap-3 p-3">
          <Button variant="link" className="btn-text-icon"><i className="icon-gcsc icon-button icon-xls me-2"></i> 중국어선 분석 다잡아 시스템.xlsx</Button>
      ...
      <div className="mt-3">
        ...
        <div className="d-flex align-items-center flex-wrap gap-3 p-3">
          ...
          <ToggleButton id="toggle-favorite" type="checkbox" variant="secondary" className="btn-icon btn-favorite" checked={checked} value={1} onChange={(e) => setChecked(e.currentTarget.checked)}>
            <i className="icon-gcsc icon-button size-30 icon-star"></i>
          </ToggleButton>
        </div>
      </div>
      ...
      <div className="mt-3">
        <h4>Size</h4>
        <div className="d-flex align-items-center flex-wrap gap-3 p-3">          
          <Button variant="primary" className="btn-xs">X-Small</Button>
      ...
      <div className="mt-3">
        <h4>Width</h4>
        <div className="d-flex align-items-center flex-wrap gap-3 p-3">          
        <Button variant="primary" className="mw-auto">min-width auto</Button>
          <Button variant="primary" className="mw-80px">min-width 80px</Button>
          <Button variant="primary" className="w-140px">width 140px</Button>
          <Button variant="primary" className="btn-block">Block</Button>
        </div>
      </div>
      ...
      <div className="mt-3">
        <h4>Round</h4>
        <div className="d-flex align-items-center flex-wrap gap-3 p-3">          
          <Button variant="primary" className="rounded-1">rounded</Button>
          <Button variant="primary" className="rounded-pill">rounded-pill</Button>
          <Button variant="primary" className="rounded-circle">C</Button>
        </div>
      </div>
      ...
      <div className="mt-3">
        <h4>안쓰지만 참고 버튼</h4>
        <div className="d-flex align-items-center flex-wrap gap-3 p-3 bg-dark-subtle">
          <Button variant="icon" className="btn-bi btn-white"><i className="bi bi-arrows-angle-expand"></i></Button> 
          <Button variant="icon" size="lg" className="btn-bi btn-white"><i className="bi bi-search"></i></Button>
        </div>
      </div>
