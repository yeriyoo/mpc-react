        ...
        <div className="contents">
          <div className="breadcrumb-group">
            <Breadcrumb>
              ...
              <Breadcrumb.Item active>감사 로그 통계</Breadcrumb.Item>
            </Breadcrumb>
          </div>
          <div className="contents-items">
            <div className="contents-title">감사 로그 통계</div>

            <div className="items-group mt-20">
              <div className="header">
                <div className="left">
                  <div className="title">감사 통계 목록</div>
                </div>
              </div>
            </div>
            ...
            <Container fluid>
                    ...
                    <div className="body">
                      <div className="grid-group">
                        <div className="grid-header">
                          <div className="left">
                            <div className="title">감사 일자별 현황</div>
                          </div>
                          <div className="right">
                ...
                <Col>
                  <div className="info2-group mt-header">
                    <ul className="list-style-square">
                      <li>감사로그통계의 일자별 통계입니다.</li>
                      <li>통계자료는 '실시간통계'입니다. 그러므로 '감사로그'에서 조회한 정보는 바로 통계자료에 반영합니다.</li>
                      <li>일자</li>
                      <li>성조회, 저장/삭제, 출력 다운로드가 있는 일자만 리스트로 출력합니다.</li>
                    </ul>
                  </div>
                </Col>
              </Row>
                  ...
                  <div className="items-group mt-20">
                    <div className="body">
                      <div className="grid-group">
                        <div className="grid-header">
                          <div className="left">
                            <div className="title">감사 메뉴별 현황</div>
                          </div>
                          <div className="right">
                            <div className="buttons">
                              <Button variant="outline-primary">엑셀</Button>
                ...
                <Col>
                  <div className="info2-group mt-header">
                    <ul className="list-style-square">
                      ...
                      <li>통계자료는 '실시간통계'입니다. 그러므로 '감사로그'에서 조회한 정보는 바로 통계자료에 반영합니다.</li>
                      <li>메뉴</li>
                      <li>조회, 저장/삭제, 출력 다운로드가 있는 일자만 리스트로 출력합니다.</li>
                      <li>메뉴 : 알수없음</li>
                      <li>조회년도/월에 감사에 대한 메뉴가 실제 메뉴코드와 일치하지 않는 건수</li>
                    </ul>
                  </div>
                </Col>
              </Row>
              <Row>
                  ...
                  <div className="items-group mt-20">
                    <div className="body">
                      <div className="grid-group">
                        <div className="grid-header">
                          <div className="left">
                            <div className="title">감사 사용자별 현황</div>
                          </div>
                          <div className="right">
                            <div className="buttons">
                              <Button variant="outline-primary">엑셀</Button>
                ...
                <Col>
                  <div className="info2-group mt-header">
                    <ul className="list-style-square">
                      <li>감사의 사용자별 통계입니다.</li>
                      <li>통계자료는 '실시간통계'입니다. 그러므로 '감사로그'에서 조회한 정보는 바로 통계자료에 반영합니다.</li>
                      <li>사용자</li>
                      <li>조회, 저장/삭제, 출력 다운로드한 사용자만 출력합니다.</li>
                    </ul>
                  </div>
                </Col>
              </Row>
