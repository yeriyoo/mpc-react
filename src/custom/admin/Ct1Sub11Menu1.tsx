        ...
        <div className="contents">
          <div className="breadcrumb-group">
            <Breadcrumb>
              ...
              <Breadcrumb.Item active>감사 로그</Breadcrumb.Item>
            </Breadcrumb>
          </div>
          <div className="contents-items">
            <div className="contents-title">감사 로그</div>

            <div className="items-group mt-20">
              <div className="header">
                <div className="left">
                  <div className="title">감사 로그 목록</div>
                </div>
              </div>
            </div>
            ...
            <div className="info2-group mt-20">
              <div className="info2-text">※ 감사 로그</div>
