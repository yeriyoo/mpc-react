...
const Ct1Sub8Menu2 = () => {
  ...
  return (
    ...
    <div className="admin-wrap admin-dashboard">
      ...
      <div className="lnb">
          <div className="lnb-menu-title">메뉴 관리</div>
          <div className="lnb-menu">
            <ListGroup defaultActiveKey="#2">
              <ListGroup.Item action href="#1">메뉴 목록 관리</ListGroup.Item>
              <ListGroup.Item action href="#2">메뉴 권한 관리</ListGroup.Item>
            </ListGroup>
          </div>
        </div>
        <div className="contents">
          <div className="breadcrumb-group">
            <Breadcrumb>
              ...
              <Breadcrumb.Item active>메뉴 권한 관리</Breadcrumb.Item>
            </Breadcrumb>
          </div>
          <div className="contents-items">
            <div className="contents-title">메뉴 권한 관리</div>

            <div className="items-group mt-20">
              <div className="header">
                <div className="left">
                  <div className="title">메뉴 권한</div>
                </div>
              </div>
            </div>
