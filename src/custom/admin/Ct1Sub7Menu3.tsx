...
const Ct1Sub7Menu3 = () => {
  ...
  return (
    <>
    {/* 사용자 관리 - 권한 관리 - 사용자메뉴 권한 관리 - 그룹메뉴권한관리 */}
        ...
        <div className="contents">
          <div className="breadcrumb-group">
            <Breadcrumb>
              ...
              <Breadcrumb.Item active>그룹 메뉴 권한 관리</Breadcrumb.Item>
            </Breadcrumb>
          </div>
          <div className="contents-items">
            <div className="contents-title">그룹 메뉴 권한 관리</div>
                  ...
                  <div className="items-group mt-20">
                    <div className="body">
                      <div className="grid-group">
                        <div className="grid-header">
                          <div className="left">
                            <div className="title">메뉴 권한 목록</div>
                          </div>
                        </div>
