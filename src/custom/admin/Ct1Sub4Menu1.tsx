  ...
  return (
    ...
    <div className="admin-wrap admin-dashboard">
      ...
      <div className="admin-content">
        <div className="lnb">
          <div className="lnb-menu-title">권한 설정</div>
          <div className="lnb-menu">
            <ListGroup defaultActiveKey="#1">
              <ListGroup.Item action href="#1">권한 설정</ListGroup.Item>
            </ListGroup>
          </div>
        </div>
        <div className="contents">
          <div className="breadcrumb-group">
            <Breadcrumb>
              ...
              <Breadcrumb.Item>권한 설정</Breadcrumb.Item>
              <Breadcrumb.Item active>권한 설정</Breadcrumb.Item>
            </Breadcrumb>
          </div>
          <div className="contents-items">
            <div className="contents-title">권한 설정</div>
