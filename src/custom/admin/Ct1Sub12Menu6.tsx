        ...
        <div className="contents">
          <div className="breadcrumb-group">
            <Breadcrumb>
              ...
              <Breadcrumb.Item active>배치 로그 통계</Breadcrumb.Item>
            </Breadcrumb>
          </div>
          <div className="contents-items">
            <div className="contents-title">배치 로그 통계</div>

            <div className="items-group mt-20">
              <div className="header">
                <div className="left">
                  <div className="title">배치 통계 목록</div>
                </div>
              </div>
            </div>
                    ...
                    <div className="body">
                      <div className="grid-group">
                        <div className="grid-header">
                          <div className="left">
                            <div className="title">배치 일자별 현황</div>
                          </div>
                          <div className="right">
                ...
                <Col>
                  <div className="info2-group mt-header">
                    <ul className="list-style-square">
                      <li>배치의 일자별 통계입니다.</li>
                      <li>통계자료는 '실시간통계'입니다. 그러므로 '배치 로그'에서 조회한 정보는 바로 통계자료에 반영합니다.</li>
                      <li>일자</li>
                      <li>DB, JS, JAVA가 있는 일자만 리스트로 출력합니다.</li>
                    </ul>
                  </div>
                </Col>
              </Row>
                  ...
                  <div className="items-group mt-20">
                    <div className="body">
                      <div className="grid-group">
                        <div className="grid-header">
                          <div className="left">
                            <div className="title">배치 실행자별 현황</div>
                          </div>
                          <div className="right">
                            <div className="buttons">
                              <Button variant="outline-primary">엑셀</Button>
