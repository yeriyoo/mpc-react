...
const Ct1Sub7Menu2 = () => {
  ...
  return (
    <>
    {/* 사용자 관리 - 권한 관리 - 사용자메뉴 권한 관리 - 그룹사용자관리 */}
    <div className="admin-wrap admin-dashboard">
      ...
      <div className="lnb">
          <div className="lnb-menu-title">그룹 관리</div>
          <div className="lnb-menu">
            <ListGroup defaultActiveKey="#1">
              <ListGroup.Item action href="#1">권한 그룹 관리</ListGroup.Item>
            </ListGroup>
          </div>
        </div>
        <div className="contents">
          <div className="breadcrumb-group">
            <Breadcrumb>
              ...
              <Breadcrumb.Item>그룹 관리</Breadcrumb.Item>
              <Breadcrumb.Item>권한 그룹 관리</Breadcrumb.Item>
              <Breadcrumb.Item active>그룹 사용자 관리</Breadcrumb.Item>
            </Breadcrumb>
          </div>
          <div className="contents-items">
            <div className="contents-title">그룹 사용자 관리</div>
                  ...
                  <div className="items-group mt-20">
                    <div className="body">
                      <div className="grid-group">
                        <div className="grid-header">
                          <div className="left">
                            <div className="title">그룹 계정 목록</div>
                          </div>
                          <div className="right">
                            <div className="buttons">
