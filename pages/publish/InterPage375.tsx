...
const InterPage375 = () => {
  ...
  const [activeSheet, setActiveSheet] = useState<'BottomTable01' | 'BottomTable02' | null>(null);
      ...
      <div className="navbar-wrapper">
        ...
        <Dropdown className="dropdown-bottom-right" onToggle={(open) => setIsOpen(open)}>
          ...
          <Dropdown.Menu className="custom-dropdown-menu">
            <Dropdown.Item>
              <img src="src/assets/dr-icon-00.svg" />
            </Dropdown.Item>
            <Dropdown.Item>
              <img src="src/assets/dr-icon-01.svg" />
            </Dropdown.Item>
            <Dropdown.Item>
              <img src="src/assets/dr-icon-02.svg" />
            </Dropdown.Item>
            <Dropdown.Item>
              <img src="src/assets/dr-icon-03.svg" />
            </Dropdown.Item>
            <Dropdown.Item>
              <img src="src/assets/dr-icon-04.svg" />
            </Dropdown.Item>
            <Dropdown.Item>
              <img src="src/assets/dr-icon-05.svg" />
            </Dropdown.Item>
            <Dropdown.Item>
              <img src="src/assets/dr-icon-06.svg" />
            </Dropdown.Item>
            <Dropdown.Item>
              <img src="src/assets/dr-icon-07.svg" />
            </Dropdown.Item>
          </Dropdown.Menu>
        </Dropdown>
        ...
        <div className="map-container">
          {/* <button
            className="location-button-02"
            onClick={() => console.log('위치 이동 버튼 클릭됨')}
          >
          ...
          <>
            ...
            <div>
              <img
                ...
                src="src/assets/wing-logo-375.svg"
                alt="logo"
              />
            </div>
