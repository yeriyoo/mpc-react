  ...
  return (
    <Dropdown className="d-inline mx-2" autoClose="outside">
      ...
      <Dropdown.Menu className="dropdown-icon-menu">
        ...
        <Dropdown.Item className="dropdown-item-with-label">
          <img
            src="src/assets/map-small-02.png"
            style={{
              width: '28px',
              border: '2px solid #C2CDDE',
              borderRadius: '4px',
